...
function hamburger_click(){
  var home_links = document.getElementsByClassName("links_m")[0];
  ...
  if (home_links.style.display === 'block') {
    ...
    line1.style.width = '2.25rem';
    line2.style.width = '2.25rem';
    line3.style.width = '2.25rem';
    ...
    line1.style.transform = 'rotate(-45deg) translateY(.82rem)';
    line2.style.opacity = 0;
    line3.style.transform = 'rotate(45deg) translateY(-.82rem)';
  }
}
// Gallary Slideshow
var slideNo = 1;
function wrap_around(index) {
  var slides_div = document.querySelector(".gallery_photos");
...
function showSlide(slideIndex) {
  ...
  var slides = document.querySelectorAll(".gallery_photos img");
...
function description(element) {
  ...
  var description_id = 'div_' + parent_id;
